...
void MsgPostInsAllotAck(CMessage *const pMsg)
{
    ...
    ptMsgAckInfo = (TMsgAckInfo*)pchMsgGet;

    // 消息发送;
    OspPost(MAKEIID(DEMO_APP_SERVER_NO, ptMsgAckInfo->m_wNodeNo), EVENT_MSG_POST, ptMsgAckInfo->m_achMsg, (wMsgLen - 2*sizeof(u16)),
