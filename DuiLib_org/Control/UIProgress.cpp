...
// 				if ((m_cxyFixed.cx - rc.right) >= 18){
// 					m_sForeImageModify.SmallFormat(_T("dest='%d,%d,%d,%d' source='%d,%d,%d,%d'")
// 						, rc.left, rc.top, rc.right, rc.bottom
// 						, m_cxyFixed.cx - rc.right + 18, rc.top, m_cxyFixed.cx + 18, rc.bottom);
// 				}else{
// 					m_sForeImageModify.SmallFormat(_T("dest='%d,%d,%d,%d' source='%d,%d,%d,%d'")
// 						, rc.left, rc.top, rc.right, rc.bottom
// 						, 2*m_cxyFixed.cx - 2*rc.right, rc.top, 2*m_cxyFixed.cx - rc.right, rc.bottom);
// 				}
			}
